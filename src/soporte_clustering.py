...
class Clustering:
    ...
    def modelo_kmeans(self, dataframe_original: pd.DataFrame, num_clusters):
        """
    ...
    def modelo_aglomerativo(self, num_clusters, metodo_distancias, dataframe_original: pd.DataFrame):
        """
    ...
    def modelo_divisivo(self, dataframe_original: pd.DataFrame, threshold=0.5, max_clusters=5):
        """
    ...
    def modelo_espectral(self, dataframe_original: pd.DataFrame, n_clusters=3, assign_labels='kmeans'):
        """
    ...
    def modelo_dbscan(self, dataframe_original: pd.DataFrame, eps_values=[0.5, 1.0, 1.5], min_samples_values=[3, 2, 1]):
        """
