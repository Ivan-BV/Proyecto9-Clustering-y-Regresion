...
class AnalisisModelosClasificacion:
    def __init__(self, dataframe, variable_dependiente):
        ...
        self.resultados = {nombre: {"mejor_modelo": None, "pred_train": None, "pred_test": None, "time": None} for nombre in self.modelos}
    ...
    def ajustar_modelo(self, modelo_nombre, param_grid=None):
        ...
        self.resultados[modelo_nombre]["time"] = elapsed_time
    ...
    def calcular_metricas(self, modelo_nombre):
        ...
        elapsed_time = self.resultados[modelo_nombre]["time"]
